...
function useCurrentColorScheme(options) {
  ...
  const setMode = React32.useCallback((mode) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React33.useContext(ColorSchemeContext) || defaultContext;
...
function CssBaseline(inProps) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React41.Fragment, {
    children: [isDynamicSupport && (0, import_jsx_runtime17.jsx)(GlobalStyles4, {
      enableColorScheme
    }), !isDynamicSupport && !enableColorScheme && (0, import_jsx_runtime17.jsx)("span", {
      className: SELECTOR,
      style: {
        display: "none"
      }
...
true ? CssBaseline.propTypes = {
   ...
   * @default false
   */
  enableColorScheme: import_prop_types23.default.bool
} : void 0;
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VYZYCNSB.js.map
